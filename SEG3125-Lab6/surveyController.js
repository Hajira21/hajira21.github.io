...
// update the data file, I use "name" to be equal to improve, or difficulty or useful
...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var easy = readData("easy");
        var likert = readData("likert");
        var productive = readData("productive");

        res.render('showResults', {results: [easy, useful, difficulty, improve, likert, productive]});
        console.log([easy, useful, difficulty, improve, likert, productive]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key === "useful") && (json[key].length === 2)){
